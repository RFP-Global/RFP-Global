...
const Index = () => {
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-black to-[#001A0F] overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-[500px] h-[500px] bg-[#2EE697]/10 rounded-full blur-[120px]" />
      <div className="absolute bottom-1/4 left-1/4 w-[500px] h-[500px] bg-[#2EE697]/10 rounded-full blur-[120px]" />
